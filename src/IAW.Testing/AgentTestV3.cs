...
public sealed class AgentTestV3SiloConfigurator : ISiloConfigurator
{
...
public sealed class AgentTestV3ClientConfigurator : IClientBuilderConfigurator
{
...
public abstract class AgentTestV3<TAgent> : IAsyncLifetime where TAgent : Agent
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        builder.AddSiloBuilderConfigurator<AgentTestV3SiloConfigurator>();
        builder.AddClientBuilderConfigurator<AgentTestV3ClientConfigurator>();
